...
const translations = {
  ...
  benchmarks: {
    ...
    filterByBrand: { it: "Filtra brand", en: "Filter brands" },
    selectAllBrands: { it: "Tutti i brand", en: "All brands" },
    allBrandsSelected: { it: "Tutti i brand selezionati", en: "All brands selected" },
