              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium h-9 px-4 py-2 bg-gold text-gold-foreground hover:bg-[#174ac0] shadow-sm"
                  >
